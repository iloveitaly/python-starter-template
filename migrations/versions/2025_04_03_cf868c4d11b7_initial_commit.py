...
Revision ID: cf868c4d11b7
Revises: 
Create Date: 2025-04-03 19:32:07.587088
...
def upgrade() -> None:
    ...
    sa.Column('id', activemodel.types.typeid.TypeIDType(prefix='llr'), nullable=False, comment='TypeID with prefix: llr'),
