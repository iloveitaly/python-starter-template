...
@overload
def react_router_path(
    path: Literal["/"], params: None | Mapping[str, object] = None, /
) -> str: ...


@overload
def react_router_path(
    path: Literal["/home"], params: None | Mapping[str, object] = None, /
) -> str: ...


@overload
def react_router_path(
    path: Literal["/form"], params: None | Mapping[str, object] = None, /
) -> str: ...


@overload
def react_router_path(
    path: Literal["/logout"], params: None | Mapping[str, object] = None, /
) -> str: ...


@overload
def react_router_path(
    path: RoutePaths, params: None | Mapping[str, object] = None, /
) -> str: ...


def react_router_path(
    path: RoutePaths, params: Mapping[str, object] | None = None
) -> str:
...
@overload
def react_router_url(
    path: Literal["/"],
    params: None | Mapping[str, object] = None,
